import re
s = '''[(0,11),(1,15),(2,10),(3,5),(4,6),(8,12),(9,16),(13,14)]
...
ans = "inline constexpr void sort16(int* a) noexcept{\n"
layers = re.findall(r'\[([^\]]+)\]', s)
for i in layers:
    ans += '    '
    numbers = [int(n) for n in re.findall(r'\d+', i)]
